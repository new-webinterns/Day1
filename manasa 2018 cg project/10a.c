...
void optimal(char[],char[],int,int);
...
void optimal(char reference_string[25],char frames[10],int l,int f)
{
      
int interval[25];
      int pages=l, total_frames=f, page_faults = 0;
